...
public class StreamExercise {
	public static void main(final String[] args) {
		...
		// 1. print out all gmail logins

		// 2. find names of all women with surname containing the letter K or k

		// 3. find out the average age of men, find out the average age of women
	}
}
